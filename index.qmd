...
data.frame(
  ...
  Lecture = c(
    '<a href="https://gatech.box.com/s/yjb8q69k4e63ogufooccrfkd097di3m2" target="_blank">Slides</a>',
    '<a href="https://gatech.box.com/s/e3mbpg5i590dzcz8fhedhwjszq8fjsve" target="_blank">Slides</a>',
    '<a href="https://gatech.box.com/s/tuhlzrrfosl4i7zgd2gqp0yir2b428zh" target="_blank">Slides</a>',
    '<a href="https://gatech.box.com/s/tqgn2agytnu1gltndcvqjfirag4j87jt" target="_blank">Slides</a>'
  ),
  Exercises = c(
...
data.frame(
  ...
  Lecture = c(
    '<a href="https://gatech.box.com/s/04qa51r6tw7prfhdflc1taroim6jaudv" target="_blank">Slides</a>',
    '<a href="https://gatech.box.com/s/k4q4mtscwa9txdcc6qdxiviyrzob3djf" target="_blank">Slides</a>',
    '<a href="https://gatech.box.com/s/gr7jq894brykdq4s64nqd09b5guateel" target="_blank">Slides</a>',
    '<a href="https://gatech.box.com/s/f9hhb4cjnumy4i7yp7hgxcyv3fgwo9xf" target="_blank">Slides</a>'
  ),
  Exercises = c(
...
data.frame(
  ...
  Exercises = c(
    '<a href="analysis/QG3_Polygenic_Scores_practical.html">Practical</a>',
    '<a href="analysis/QG3_CC_Imbalance_practical.html">Practical</a>'
  ),
  Key = c("", "")
) %>%
